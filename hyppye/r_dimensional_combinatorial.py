...
def setup_parser():
    ...
    parser.add_argument('-s', '--stats',  action='store_true',
                        help= 'get statistics')
    parser.add_argument('-ss', '--stats_sample', metavar = 'sample for computing evaluation metrics', type=int,
                        help= 'get statistics')
